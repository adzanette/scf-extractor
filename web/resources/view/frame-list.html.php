...
<div class="container-fluid">
  <div class="row-fluid">
    <div class="span12 well text-center">
      ...
      <a class="btn btn-warning" title="Voltar para os verbos" href="<?php $template->getLink('verb-list', array('corpus' => $corpus, 'page' => $verbPage))?>">Voltar para os verbos</a>
      <?php echo $pagination; ?>
    </div>
  </div>
  <table class="table table-bordered table-hover">
    ...
    foreach($frames as $frame){
      ...
      <tr>
        ...
        <td>
          <a class="btn btn-success" title="Ver Exemplos" href="<?php $template->getLink('example-list', array('corpus' => $corpus, 'verbId' => $verb->id_verb, 'verbPage' => $verbPage, 'frameId' => $frame->id_frame, 'framePage' => $page, 'page' => 1))?>">
